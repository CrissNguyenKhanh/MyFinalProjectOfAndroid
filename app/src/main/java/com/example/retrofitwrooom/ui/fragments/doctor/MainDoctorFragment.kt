...
class MainDoctorFragment : Fragment() {
    ...
    private var _binding: FragmentMainDoctorBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentMainDoctorBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.imageBack.setOnClickListener {
            findNavController().navigate(R.id.action_mainDoctorFragment_to_mainFragment)
        }
        ...
        binding.seeAll.setOnClickListener {
            val bundle = Bundle().apply {
                putInt("departmentid" , 1)
            }
            findNavController().navigate(R.id.action_mainDoctorFragment_to_doctorFragment , bundle)
        }
    }
