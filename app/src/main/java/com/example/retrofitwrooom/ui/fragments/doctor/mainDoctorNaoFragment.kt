...
import com.example.retrofitwrooom.databinding.FragmentMainDoctorNaoBinding
...
class mainDoctorNaoFragment : Fragment() {

    private lateinit var viewModel: doctorViewModel
    private var _binding: FragmentMainDoctorNaoBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentMainDoctorNaoBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.imgBack.setOnClickListener {
            findNavController().navigate(R.id.action_mainDoctorNaoFragment_to_mainFragment)
        }
        setupRecyclerView()
        ...
        binding.seeAll.setOnClickListener {
            val bundle = Bundle().apply {
                putInt("departmentid" , 2)
            }
            findNavController().navigate(R.id.action_mainDoctorNaoFragment_to_doctorFragment,bundle)
        }
    }
