...
class notificationByMeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_notification_by_me, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment notificationByMeFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            notificationByMeFragment().apply {
