...
import com.example.retrofitwrooom.databinding.FragmentBenhNhanTimBinding
...
class BenhNhanTimFragment : Fragment() {

    private lateinit var viewModel: doctorViewModel
    private var _binding: FragmentBenhNhanTimBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentBenhNhanTimBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.imageBack.setOnClickListener {
            findNavController().navigate(R.id.action_benhNhanTimFragment_to_mainFragment)
        }
        ...
        binding.seeAll.setOnClickListener {
            val bundle = Bundle().apply {
                putInt("departmentid" , 3)
            }
            findNavController().navigate(R.id.action_benhNhanTimFragment_to_doctorFragment , bundle)
        }
    }
